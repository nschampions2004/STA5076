...
6.13
```{r}
f <- c(9.2, 7.7, 11.9, 6.2, 9.0, 8.4, 6.9, 7.6, 7.4, 8.0, 9.9, 6.7, 8.4, 9.3, 9.1, 8.7, 
       9.2, 9.1, 8.4, 9.6, 7.7, 9.0, 9.0, 8.4)
m <- c(10.4, 8.9, 11.7, 12.0, 8.7, 9.4, 9.8, 9.0, 9.2, 9.7, 9.1, 8.8, 7.9, 9.9, 10.0, 
...
6.28 t-test
```{r}
#p-value for tscore of 0.9079 with df = 9
1-pt(0.9079, df = 9)
```
